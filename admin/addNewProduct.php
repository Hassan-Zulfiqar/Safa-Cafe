...
<?php 
$productName = $productImage = $productCategoryID = $productSubCategoryID = $productPrice = $productDescription = "";
$productDiscount = "0";
$productNameErr = $productImageErr = $productCategoryIDErr = $productSubCategoryIDErr = $productPriceErr = $productDiscountErr = $productDescriptionErr = "";
...
if (isset($_POST['addNewProductBtn'])) {
    ...
    if( basename($_FILES["val-productImage"]["name"] != "")){
        ...
        $productImageErr = "Please Upload Product Image.";
    ...
    if ($productNameErr == "" && $productImageErr == "" && $productDiscountErr == "" && $productPriceErr == "" && $productDescriptionErr == "" && $productCategoryIDErr == "" && $productSubCategoryIDErr == "")  {
        ...
        $sql = "INSERT INTO `tbl_products` (`product_name`,`product_categoryID`,`product_subCategoryID`,`product_image`,`product_price`,`product_discount`,`product_description`,`product_status`,`product_createdDate`) VALUES ('$productName','$productCategoryID','$productSubCategoryID','$productImage','$productPrice','$productDiscount','$productDescription','$productStatus','$productCreatedDate')";
                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            ...
                            <p class="mb-0">Add Details of Your Product</p>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="form-valide" action="addNewProduct.php" method="post" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-xl-12">
                                            ...
                                            <div class="col-xl-6">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-lg-8 ml-auto">
                                                        <button type="submit" class="btn btn-primary" name="addNewProductBtn">Add New Product</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
