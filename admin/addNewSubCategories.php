...
if (isset($_POST['updateSubCategoryBtn'])) {
    if (empty($_POST['val-subCategoryname'])) {
        ...
        if (checkSubCategoryExist($subCategoryName,$categoryID)>0) {
    ...
    if ($subCategoryNameErr == "" && $subCategoryStatusErr == "" && $subCategoryImageErr == "")  {
        $subCategoryCreatedDate = date("Y-m-d H:i:s");
        $subCategoryStatus = "A";

        $sql = "INSERT INTO `tbl_subcategories` (`subcategory_name`,`subcategory_categoryID`,`subcategory_image`,`subcategory_status`,`subcategory_createdDate`) VALUES ('$subCategoryName','$categoryID','$subCategoryImage','$subCategoryStatus','$subCategoryCreatedDate')";
        $result = mysqli_query($conn,$sql);
        if ($result) {
            $_SESSION['successMessage'] = "Sub Category Added Successfully";
                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Add New Sub Category of <?php echo $categoryName; ?></h4>
                            <p class="mb-0">Add Details of Your Sub Category of <?php echo $categoryName; ?></p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Add Sub Category Details</h4>
                            </div>
                            <div class="card-body">
                                <form class="form-valide" action="addNewSubCategories.php?categoryID=<?php echo $categoryID; ?>" method="post" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-xl-12">
