...
if (isset($_POST['updateCategoryBtn'])) {
    if (empty($_POST['val-categoryname'])) {
        ...
        if (checkCategoryExist($categoryName,$categoryID)>0) {
            $categoryNameErr = "Category Name already Exist.";
        }
    }

    if (empty($_POST['val-categorystatus'])) {
        $categoryStatusErr = "Please enter Category Status.";
    }else{
        $categoryStatus = mysqli_real_escape_string($conn,$_POST['val-categorystatus']);
    }
    ...
    if ($categoryNameErr == "" && $categoryStatusErr == "" && $categoryImageErr == "")  {
        $categoryUpdateDate = date("Y-m-d H:i:s");
        $sql = "UPDATE `tbl_categories` SET `category_name` = '$categoryName', `category_status` = '$categoryStatus', `category_image` = '$categoryImage' WHERE `category_id` = '$categoryID'";
        $result = mysqli_query($conn,$sql);
        if ($result) {
                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            ...
                            <p class="mb-0">Update Details of Your Category</p>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="form-valide" action="editCategories.php?categoryID=<?php echo $categoryID; ?>" method="post" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-xl-12">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-lg-4 col-form-label" for="val-email">Category Status <span
                                                            class="text-danger">*</span>
                                                    </label>
                                                    <div class="col-lg-6">
                                                        <select class="form-control" name="val-categorystatus" id="val-categorystatus">
                                                            <option value="">Select Status</option>
                                                            <option value="A" <?php if($categoryStatus == "A"){echo "selected";} ?>>Active</option>
                                                            <option value="B" <?php if($categoryStatus == "B"){echo "selected";} ?>>Blocked</option>
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-lg-4 col-form-label" for="categoryImage">Category Image 
                                                    </label>
                                                    <div class="col-lg-5">
                                                        <input type="file" class="form-control" id="categoryImage" name="categoryImage" placeholder="..Upload Category image">
                                                    ...
                                                    <div class="col-lg-1">
                                                        <?php if($categoryImage != "" && file_exists($categoryImage)){
                                                            ?>
                                                                <img src="<?php echo $categoryImage; ?>" style="width: 50px; height:50px;">
                                                            <?php
                                                        } ?>
                                                    </div>
        ...
        jQuery(".form-valide").validate({
            ...
            messages: {
                "val-categoryname": {
                    ...
                    minlength: "Your categoryname must consist of at least 3 characters"
                },
                "val-categorystatus": {
