                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>View All Top Order Product(s) Report</h4>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        $sql = "SELECT o.order_id, o.order_date, p.product_id, p.product_name, p.product_image,p.product_description,p.product_status,c.category_name,COUNT(*) AS order_count
                                            FROM tbl_orders o
                                            ...
                                            JOIN tbl_categories c ON p.product_categoryID = c.category_id
                                                ...
                                                <tbody>
                                                    ...
                                                    while($row = mysqli_fetch_array($result)){
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo $row['order_count']." Order(s)"; ?></td>
